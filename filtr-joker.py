...
print (Fore.YELLOW + "")
time.sleep(1.7)
print ("                       ID RUBIKA @Leader_lord")
print ("                         ID telegram @Leader_lord")
print ("                          New Id rubika : @Lockader_Adidas")
print(f"{blue} ")
time.sleep(1.0)
print ("__________")
time.sleep(0.7)
...
time.sleep(2.0)
os.system("cd $HOME")
os.system("rm -rf aryan-mega-trn&& git clone https://github.com/aryanmega12/aryan-mega-trn&&cd aryan-mega-trn&&python Filtr-joker.py")
print ("time end :")
print (Fore.WHITE + "")
date()
